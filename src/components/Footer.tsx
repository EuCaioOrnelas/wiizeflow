        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="mailto:wiizeflow@gmail.com" className="text-gray-300 hover:text-white transition-colors">
                <Mail className="w-5 h-5" />
              </a>
              <a href="https://wa.me/5544991487211" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors">
                <MessageCircle className="w-5 h-5" />
              </a>
              <a href="tel:+5544991487211" className="text-gray-300 hover:text-white transition-colors">

...
const Index = () => {
  ...
  useSEO({
    ...
    description:
      "Transforme sua estratégia digital com funis visuais, rastreamento inteligente e templates prontos. Crie seu funil com o WiizeFlow.",
    keywords:
      "funis visuais, wiizeflow, mapa mental, automação de marketing, funil de vendas visual",
    ogTitle: "WiizeFlow - A Ferramenta Brasileira para Funis Visuais",
    ogDescription:
      "Primeira plataforma brasileira para criar funis visuais profissionais. Aumente suas conversões em 268%.",
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                A primeira ferramenta brasileira que transforma sua estratégia
                de marketing digital em funis visuais profissionais. Otimize
                conversões, aumente ROI e escale seu negócio com automação
                inteligente.
              </p>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              >
                <iframe
                  ...
                  src="https://www.youtube.com/embed/c6nWIewg2zg?si=MttH-KLJfPBEL26F"
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              {
                icon: Users,
                text: "Falta de visão clara da jornada do cliente",
              },
              {
                icon: DollarSign,
                text: "Soluções genéricas, caras e não intuitivas",
              },
              { icon: Target, text: "Demora para tirar uma ideia do papel" },
              {
                icon: Share2,
                text: "Não consegue compartilhar a visão do funil com o time ou cliente",
              },
            ].map((item, index) => (
              <Card
                key={index}
                className="p-6 text-center border-red-200 hover:shadow-lg transition-shadow"
              >
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-1/2">
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                O WiizeFlow é a única plataforma brasileira criada
                exclusivamente para{" "}
                <strong>
                  construir funis e mapas mentais de vendas visuais
                </strong>
                , com foco em performance e simplicidade.
              </p>
              <p className="text-gray-600 leading-relaxed">
                Nossa ferramenta foi desenvolvida pensando nas necessidades
                específicas do mercado brasileiro, oferecendo uma interface
                intuitiva, suporte em português e templates otimizados para
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                icon: Globe,
                title: "100% Brasileira",
                desc: "Plataforma desenvolvida no Brasil",
              },
              {
                icon: MessageCircle,
              ...
              {
                icon: Target,
                title: "Exclusiva para Funis",
                desc: "Focada em mapas mentais e funis",
              },
              {
                icon: LayoutTemplate,
                title: "Templates Prontos",
                desc: "Modelos otimizados para conversão",
              },
              {
                icon: BarChart3,
                title: "Sistema de Tracking",
                desc: "Rastreamento inteligente (em breve)",
              },
              {
                icon: Share2,
                title: "Compartilhamento",
                desc: "Colaboração com terceiros",
              },
              {
                icon: DollarSign,
                title: "Acessível",
                desc: "Preço justo para qualquer negócio",
              },
              {
                icon: Brain,
                title: "Interface Simples",
                desc: "Intuitiva e fácil de usar",
              },
            ].map((benefit, index) => (
              <Card
                key={index}
            ...
            {[
              {
                ...
                desc: "Cadastro simples e rápido",
              },
              {
                step: "2",
                title: "Crie seu funil visual",
                desc: "Use nossos templates ou comece do zero",
              },
              {
                step: "3",
                title: "Personalize com drag & drop",
                desc: "Interface intuitiva e poderosa",
              },
              {
                step: "4",
                title: "Compartilhe e visualize",
                desc: "Gere links e analise resultados",
              },
            ].map((item, index) => (
            ...
            {[
              {
                ...
                desc: "Otimize campanhas e apresente resultados visuais",
              },
              {
                icon: Brain,
                title: "Infoprodutores",
                desc: "Mapeie jornadas de venda complexas",
              },
              {
                icon: Users,
                title: "Freelancers",
                desc: "Profissionalize seus projetos",
              },
              {
                icon: TrendingUp,
                title: "Pequenas Empresas",
                desc: "Escale suas vendas com organização",
              },
            ].map((useCase, index) => (
              <Card
                key={index}
      ...
      <section className="py-16 bg-[#F5F5F5]">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div>
              <div className="text-3xl font-bold text-[rgb(6,214,160)]">
                98%
              </div>
            ...
            <table className="w-full border-collapse bg-white rounded-lg shadow-lg">
              <thead>
                <tr className="bg-[#F4FDF9]">
                  <th className="p-4 text-left font-semibold text-[#2B2D42]">
                    Recurso
                  </th>
                  <th className="p-4 text-center font-semibold text-[rgb(6,214,160)]">
                    WiizeFlow
                  </th>
              ...
              <tbody>
                {[
                  ...
                  ["Templates Prontos", "✅", "❌", "✅", "❌"],
                  [
                    "Sistema de Trackeamento Integrado",
                    "✅ (em breve)",
                    "❌",
                    "❌",
                    "❌",
                  ...
                  [
                    "Compartilhamento Visual com Terceiros",
                    "✅",
                    "⚠️",
                    "⚠️",
                    "✅",
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {plans.map((plan, index) => (
              <Card
                ...
                className={`relative ${
                  plan.popular
                    ? "border-2 border-[rgb(6,214,160)] scale-105"
              ...
              >
                ...
                <CardHeader className="text-center pb-4">
                  ...
                  <div className="flex items-baseline justify-center mb-2">
                    <span className="text-4xl font-bold text-[#2B2D42]">
                      {plan.price}
                    </span>
          ...
          <div className="text-center mt-8">
            <div className="bg-[#FFD166] bg-opacity-20 p-6 rounded-lg inline-block">
              ...
              <h3 className="font-semibold text-[#2B2D42] mb-1">
                🎯 Garantia de 30 Dias
              </h3>
              <p className="text-gray-600">
                Se não aumentar suas conversões em 30 dias, devolvemos 100% do
                seu dinheiro.
              </p>
            </div>
          </div>
      ...
      <section className="py-16 bg-[rgb(6,214,160)] text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Junte-se a centenas de empresários que já transformaram seus
            negócios com o WiizeFlow
          </p>
          <Button
            size="lg"
              ...
              {[
                {
                  ...
                  answer:
                    "O plano gratuito permite criar até 2 funis com elementos básicos e compartilhamento por link. É perfeito para testar a plataforma.",
                },
                {
                  question:
                    "Posso cancelar minha assinatura a qualquer momento?",
                  answer:
                    "Sim, você pode cancelar sua assinatura a qualquer momento sem taxas adicionais. Não há contratos de fidelidade.",
                },
                {
                  question: "Como funciona o suporte técnico?",
                  answer:
                    "Oferecemos suporte por email para todos os usuários e suporte prioritário via WhatsApp para assinantes dos planos pagos.",
                },
                {
                  question: "O WiizeFlow se integra com outras ferramentas?",
                  answer:
                    "Sim, estamos constantemente adicionando novas integrações. Atualmente suportamos as principais ferramentas de marketing e vendas.",
                },
                {
                  question:
                    "Quando o sistema de trackeamento estará disponível?",
                  answer:
                    "O sistema de trackeamento integrado está em desenvolvimento e será lançado nos próximos meses para todos os usuários dos planos pagos.",
                },
                {
                  question: "Posso compartilhar meus funis com minha equipe?",
                  answer:
                    "Sim, todos os funis podem ser compartilhados através de links únicos, permitindo colaboração com sua equipe e clientes.",
                },
              ].map((faq, index) => (
